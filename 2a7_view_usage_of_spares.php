...
<html>
    <head>
        <title>View Usage of Spares</title>
        ...
        if(isset($_SESSION["id"])) {
            ...
            if ($res1 = mysqli_query($link, $q1)) {
                ...
                echo "<div class='container'>
                        ...
                        $q2="SELECT log_id, s.spare_id as spare_id,
                            part_name, quantity, log_date,
                            e.employee_id as employee_id, 
                            fname, lname
                            FROM spares_usage su
                            INNER JOIN spares s
                            ON su.spare_id=s.spare_id
                            INNER JOIN employee e
                            ON su.employee_id=e.employee_id
                            WHERE su.branch_id=$_SESSION[branch_id]";
                        if ($res2=mysqli_query($link, $q2)) {
                            if (mysqli_num_rows($res2)>0) {
                                echo "
                                <br><h1>Usage of Spares</h1><br>
                                <table>
                                    <tr>
                                        <th>Log ID</th>
                                        <th>Spare ID</th>
