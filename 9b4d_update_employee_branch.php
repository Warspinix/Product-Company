                            ...
                            if ($res2=mysqli_query($link, $q2)) {
                                ...
                                if ($res3=mysqli_query($link, $q3)) {
                                    ...
                                    if ($old_branch_id!=$new_branch_id) {
                                        ...
                                        echo "<br><h4>The employee is already at this branch.</h4><br>";                                
                                    }
                                } else {
                                    die("Error: ".mysqli_error($link));
                                }
