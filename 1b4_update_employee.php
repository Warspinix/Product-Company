                                ...
                                if ($res2 = mysqli_query($link, $q2)) {
                                    if (mysqli_num_rows($res2)==1) {
                                        ...
                                        if ($employee_id==$_SESSION["id"]) {
                                            ...
                                            if ($criteria=="name")
                                                header("Location: 1b4a_update_employee_name.php");
                                            else if ($criteria=="position")
                                                header("Location: 1b4b_update_employee_position.php");
                                            else if ($criteria=="salary")
                                                header("Location: 1b4c_update_employee_salary.php");
                                            else if ($criteria=="branch")
                                                header("Location: 1b4d_update_employee_branch.php");
                                        }
                                    } else {
